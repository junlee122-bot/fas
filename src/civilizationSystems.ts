...
export const nationCivilizationProfiles: Record<NationId, NationCivilizationProfile> = {
  britain: { nationId: 'britain', stateCapacity: 78, civicCapacity: 76, marketDepth: 82, strengths: ['information', 'science', 'transport'], constraints: ['housing', 'energy'], historicalAnchor: '의회·지방정부·제국망과 복지국가 전환이 공존해 공공서비스와 해외 네트워크의 균형이 핵심입니다.' },
  usa: { nationId: 'usa', stateCapacity: 76, civicCapacity: 72, marketDepth: 94, strengths: ['energy', 'science', 'transport'], constraints: ['housing', 'labor'], historicalAnchor: '대륙 규모의 산업·시장·대학 기반이 강하지만 연방·지역·인종·계층 격차가 정책 효과를 다르게 만듭니다.' },
  ussr: { nationId: 'ussr', stateCapacity: 91, civicCapacity: 48, marketDepth: 34, strengths: ['energy', 'education', 'science'], constraints: ['food', 'information'], historicalAnchor: '계획·동원·대형 과학사업 능력이 강하지만 지역 지식과 공개된 피드백이 약해 병목이 누적될 수 있습니다.' },
  germany: { nationId: 'germany', stateCapacity: 84, civicCapacity: 58, marketDepth: 80, strengths: ['science', 'labor', 'transport'], constraints: ['housing', 'environment'], historicalAnchor: '고숙련 산업과 행정 기반이 강하지만 전쟁·체제붕괴·분단 여부가 제도 연속성을 크게 바꿉니다.' },
  japan: { nationId: 'japan', stateCapacity: 82, civicCapacity: 61, marketDepth: 84, strengths: ['transport', 'education', 'science'], constraints: ['energy', 'housing'], historicalAnchor: '고밀도 도시·산업조직과 기술학습 능력이 강하지만 에너지·식량 수입과 재난 노출이 전략을 제한합니다.' },
  china: { nationId: 'china', stateCapacity: 64, civicCapacity: 59, marketDepth: 53, strengths: ['food', 'labor', 'transport'], constraints: ['health', 'housing'], historicalAnchor: '광대한 농촌·지역 다양성과 전쟁 피해 때문에 중앙계획의 규모와 현지 실행 능력 사이의 간극이 중요합니다.' },
  india: { nationId: 'india', stateCapacity: 58, civicCapacity: 74, marketDepth: 61, strengths: ['food', 'education', 'information'], constraints: ['health', 'transport'], historicalAnchor: '민주적 다원성과 과학·행정 인재가 강점이지만 식민지 유산, 농촌 빈곤과 대륙 규모의 서비스 격차가 큽니다.' },
  freefrance: { nationId: 'freefrance', stateCapacity: 67, civicCapacity: 71, marketDepth: 70, strengths: ['transport', 'education', 'health'], constraints: ['housing', 'energy'], historicalAnchor: '망명·저항 네트워크를 해방 후 정통성과 공화국 행정으로 전환하는 과정이 모든 사업의 효과를 좌우합니다.' },
  italy: { nationId: 'italy', stateCapacity: 62, civicCapacity: 68, marketDepth: 69, strengths: ['food', 'housing', 'labor'], constraints: ['energy', 'transport'], historicalAnchor: '도시·농촌과 남북 격차, 강한 지방사회가 중앙 개발계획의 속도와 정당성을 함께 결정합니다.' },
  korea: { nationId: 'korea', stateCapacity: 46, civicCapacity: 78, marketDepth: 43, strengths: ['education', 'information', 'labor'], constraints: ['housing', 'transport'], historicalAnchor: '식민지 지배와 분단 위험 속에서 국내망·망명정부·지역조직을 주권국가의 공공제도로 바꾸는 것이 핵심입니다.' },
  vietnam: { nationId: 'vietnam', stateCapacity: 48, civicCapacity: 76, marketDepth: 40, strengths: ['food', 'labor', 'information'], constraints: ['health', 'transport'], historicalAnchor: '농촌 조직과 독립운동의 동원력은 강하지만 장기전·식민지 경제와 파괴된 기반시설이 민생 전환을 어렵게 합니다.' },
  indonesia: { nationId: 'indonesia', stateCapacity: 43, civicCapacity: 73, marketDepth: 52, strengths: ['food', 'information', 'labor'], constraints: ['transport', 'health'], historicalAnchor: '군도·다언어 사회에서 항로, 지방대표성과 공통 행정표준을 함께 세워야 국가 사업이 실제로 도달합니다.' },
  philippines: { nationId: 'philippines', stateCapacity: 51, civicCapacity: 69, marketDepth: 63, strengths: ['information', 'education', 'housing'], constraints: ['transport', 'energy'], historicalAnchor: '군도 물류와 식민지 제도, 지방 엘리트 권력이 보편서비스와 시장개방의 수혜 분포를 좌우합니다.' },
};
...
const branchDomains: Record<CareerRole['branch'], CivilizationDomainId[]> = {
  politics: ['food', 'housing', 'health', 'education', 'labor', 'environment'],
  military: ['energy', 'transport', 'health', 'science'],
  intelligence: ['information', 'science', 'education', 'transport'],
};
