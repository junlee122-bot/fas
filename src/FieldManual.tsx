...
const manualArticles: ManualArticle[] = [
  ...
  { id: 'battle-flow', category: 'combat', title: '4단계 작전 전투', summary: '정찰, 접근, 주력 교전, 돌파의 결과가 다음 단계로 이어집니다.', body: '초반 정찰 우세는 접근과 주력 교전의 모멘텀이 됩니다. 신중·균형·총력 태세는 정보, 화력, 보급 소모와 피해 위험을 서로 다르게 교환합니다.', tip: '총력 공세는 강한 버튼이 아니라 충분한 보급과 정보가 있을 때 쓰는 선택입니다.', keywords: ['전투', '정찰', '공세', '태세', '돌파'] },
