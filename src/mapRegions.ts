...
export const strategicMapRegions: StrategicMapRegionDefinition[] = [
  ...
  { id: 'biscay-iberia', theater: 'europe', name: '비스케이만·이베리아 접근로', shortName: '비스케이', subtitle: '브레스트·보르도·서부 지중해 접근로', camera: { centerX: 355, centerY: 520, zoom: 2.55 } },
  ...
  { id: 'eastern-front-center', theater: 'europe', name: '동부전선 중앙 돌출부', shortName: '동부 중앙', subtitle: '스몰렌스크·르제프·오룔·쿠르스크 철도축', camera: { centerX: 785, centerY: 430, zoom: 2.55 } },
  ...
  { id: 'italy-adriatic', theater: 'europe', name: '이탈리아·아드리아해 작전구', shortName: '이탈리아', subtitle: '시칠리아·칼라브리아·로마·아드리아 유격전', camera: { centerX: 585, centerY: 545, zoom: 2.75 } },
  ...
  { id: 'egypt-levant', theater: 'europe', name: '이집트·레반트·페르시아 회랑', shortName: '수에즈·중동', subtitle: '엘알라메인·수에즈·다마스쿠스·바그다드 보급축', camera: { centerX: 835, centerY: 650, zoom: 2.25 } },
  ...
  { id: 'assam-arakan', theater: 'asia', name: '아삼·임팔·아라칸 작전구', shortName: '아삼·아라칸', subtitle: '치타공·디마푸르·코히마·임팔·아키아브', camera: { centerX: 405, centerY: 430, zoom: 2.85 } },
  ...
  { id: 'china-heartland', theater: 'asia', name: '중국 중원·양쯔강 작전구', shortName: '중국 중원', subtitle: '정저우·우한·창사·난창·충칭의 전구 경계', camera: { centerX: 590, centerY: 380, zoom: 2.65 } },
  { id: 'manchuria-korea-detail', theater: 'asia', name: '남만주·조선 철도전구', shortName: '만주·조선', subtitle: '신징·다이렌·신의주·평양·경성·부산', camera: { centerX: 720, centerY: 285, zoom: 3.05 } },
  ...
  { id: 'marianas-carolines', theater: 'asia', name: '마리아나·캐롤라인 도서전구', shortName: '마리아나', subtitle: '사이판·괌·트루크·팔라우·마셜 접근로', camera: { centerX: 920, centerY: 500, zoom: 2.4 } },
];
...
export function getMapRegionForTerritory(
  ...
  return getMapRegionsForTheater(theater)
    ...
    .sort((a, b) => {
      const normalizedDistance = (candidate: StrategicMapRegionDefinition) => Math.hypot(
        (point.x - candidate.camera.centerX) / (600 / candidate.camera.zoom),
        (point.y - candidate.camera.centerY) / (380 / candidate.camera.zoom),
      );
